...
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof3(exports)) && "undefined" != typeof module ? e(exports) : "function" == typeof define && define.amd ? define(["exports"], e) : e((t = "undefined" != typeof globalThis ? globalThis : t || self).inkjs = {});
}(undefined, function (a) {
  "use strict";

  function P(t) {
    return (P = "function" == typeof Symbol && "symbol" == _typeof3(Symbol.iterator) ? function (t) {
  ...
  function f(t, e) {
    return !e || "object" != (typeof e === "undefined" ? "undefined" : _typeof3(e)) && "function" != typeof e ? function (t) {
  ...
  var t,
    ...
    return u(s, [{
      ...
      value: function value(t) {
        for (var e = new s(), n = 0, i = 0; i < t._components.length && t._components[i].isParent; ++i) {
          n++;
        }
      ...
      set: function set(t) {
        if (this._components.length = 0, this._componentsString = t, null != this._componentsString && "" != this._componentsString) {
          ...
          var e,
              n = pt(this._componentsString.split("."));
  ...
  var T = function () {
    ...
    return u(t, [{
      ...
      key: "path",
      get: function get() {
        if (null == this._path) if (null == this.parent) this._path = new O();else {
    ...
    return u(l, [{
      ...
      value: function value(t, e) {
        var n,
            i = null === (n = e.listDefinitions) || void 0 === n ? void 0 : n.FindSingleItemListWithName(t);
  ...
  var V,
    ...
    return u(g, [{
      ...
      get: function get() {
        for (var t = [], e = this; e instanceof g;) {
          0 < e.content.length && (t.push(new O.Component(0)), e = e.content[0]);
        }
  ...
  var j,
    ...
    function i() {
      var t,
          e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : i.CommandType.NotSet;
      ...
      value: function value(t) {
        ...
        if (N[n] == N[N.List]) {
          ...
          try {
            for (u.s(); !(o = u.n()).done;) {
              var l = mt(o.value, _t);
              if (l.valueType == N.List) s.push(l);else {
  ...
  var J = function () {
    ...
    return u(E, null, [{
      ...
      value: function value(t, e) {
        var n = yt(e, Ot);
        if (n) this.WriteRuntimeContainer(t, n);else {
          var i = yt(e, xt);
          ...
          var o = yt(e, x);
          if (o) t.WriteBool(o.value);else {
            var u = yt(e, wt);
            if (u) t.WriteInt(u.value);else {
              var l = yt(e, F);
              if (l) t.WriteFloat(l.value);else {
                var h = yt(e, Tt);
                if (h) h.isNewline ? t.Write("\n", !1) : (t.WriteStringStart(), t.WriteStringInner("^"), t.WriteStringInner(h.value), t.WriteStringEnd());else {
                  var c = yt(e, Pt);
                  if (c) this.WriteInkList(t, c);else {
                    var f = yt(e, Et);
                    ...
                    if (yt(e, G)) t.Write("<>");else {
                      var d = yt(e, At);
                      if (d) t.Write(E._controlCommandNames[d.commandType]);else {
                        var p = yt(e, Lt);
  ...
  var X = function () {
    ...
    return u(l, [{
      ...
      value: function value(t, e) {
        var n,
            i = pt(this.variableChangedEventCallbacks);
      ...
      set: function set(t) {
        if (this._batchObservingVariableChanges = t) this._changedVariablesForBatchObs = new Set();else if (null != this._changedVariablesForBatchObs) {
          var e,
              n = pt(this._changedVariablesForBatchObs);
      ...
      value: function value() {
        ...
        if (null !== this._changedVariablesForBatchObs) {
          var a,
              s = pt(this.patch.changedVariables);
      ...
      value: function value(t) {
        ...
        var e,
            n = pt(this._defaultGlobalVariables);
      ...
      value: function value(t, e) {
        ...
        } else for (var s = null; null != (s = yt(this.GetRawVariableWithName(n, i), W)) && (n = s.variableName, r = 0 == (i = s.contextIndex)), null != s;) {}
      ...
      value: function value(t, e) {
        ...
        if (null !== this.patch ? this.patch.SetGlobal(t, e) : this._globalVariables.set(t, e), null !== this.variableChangedEvent && null !== n && e !== n.result) if (this.batchObservingVariableChanges) {
    ...
    return u(c, [{
      ...
      value: function value(t) {
        ...
        if (null != i) {
          ...
          for (var a, s = 0, o = Object.entries(r); s < o.length; s++) {
            ...
            if (1 === Object.keys(r).length) this._currentFlow = new nt(l, this.story, h);else {
      ...
      value: function value(t) {
        var e = yt(t, G),
            n = yt(t, Tt),
            i = !0;
        if (e) this.TrimNewlinesFromOutputStream(), i = !0;else if (n) {
          var r = -1,
          ...
          if (-1 != (-1 != s && -1 != r ? Math.min(r, s) : -1 != s ? s : r)) {
            if (n.isNewline) i = !1;else if (n.isNonWhitespace && (-1 < s && this.RemoveExistingGlue(), -1 < r)) for (var h = this.callStack.elements, c = h.length - 1; 0 <= c; c--) {
              var f = h[c];
      ...
      value: function value() {
        ...
        if (0 <= t) for (e = t; e < this.outputStream.length;) {
      ...
      value: function value() {
        for (var t = this.outputStream.length - 1; 0 <= t; t--) {
          ...
          if (e instanceof G) this.outputStream.splice(t, 1);else if (e instanceof At) break;
        }
      ...
      get: function get() {
        if (0 < this.outputStream.length) for (var t = this.outputStream.length - 1; 0 <= t; t--) {
  ...
  (Z = Q = Q || {})[Z.Author = 0] = "Author", Z[Z.Warning = 1] = "Warning", Z[Z.Error = 2] = "Error", Number.isInteger || (Number.isInteger = function (t) {
    ...
    return u(f, [{
      ...
      get: function get() {
        ...
        var e,
            n = pt(this._state.currentChoices);
      ...
      value: function value(t) {
        ...
        if (t || (n = !0, t = new Y.Writer()), t.WriteObjectStart(), t.WriteIntProperty("inkVersion", f.inkVersionCurrent), t.WriteProperty("root", function (t) {
          ...
          var i,
              r = pt(this._listDefinitions.lists);
      ...
      value: function value(t) {
        ...
        if (i.Stop(), !r && this.canContinue || (null !== this._stateSnapshotAtLastNewline && this.RestoreStateSnapshot(), this.canContinue || (this.state.callStack.canPopThread && this.AddError("Thread available to pop, threads should always be flat by the end of evaluation?"), 0 != this.state.generatedChoices.length || this.state.didSafeExit || null != this._temporaryEvaluationContainer || (this.state.callStack.CanPop(Nt.Tunnel) ? this.AddError("unexpectedly reached end of content. Do you need a '->->' to return from a tunnel?") : this.state.callStack.CanPop(Nt.Function) ? this.AddError("unexpectedly reached end of content. Do you need a '~ return'?") : this.state.callStack.canPop ? this.AddError("unexpectedly reached end of content for unknown reason. Please debug compiler!") : this.AddError("ran out of content. Do you need a '-> DONE' or '-> END'?"))), this.state.didSafeExit = !1, this._sawLookaheadUnsafeFunctionAfterNewline = !1, 1 == this._recursiveContinueCount && (this._state.variablesState.batchObservingVariableChanges = !1), this._asyncContinueActive = !1, null !== this.onDidContinue && this.onDidContinue()), this._recursiveContinueCount--, null != this._profiler && this._profiler.PostContinue(), this.state.hasError || this.state.hasWarning) {
          ...
          if (this.state.hasWarning) {
            var l,
                h = pt(this.state.currentWarnings);
      ...
      value: function value() {
        ...
        for (var t = new St(); this.canContinue;) {
      ...
      value: function value() {
        ...
        if (!e.isNull) {
          for (var n = yt(e.Resolve(), Ot); n && (this.VisitContainer(n, !0), 0 != n.content.length);) {
            n = yt((e = It.StartOf(n)).Resolve(), Ot);
          }
      ...
      value: function value() {
        ...
        if (!e.isNull && -1 != e.index) {
          if (this._prevContainers.length = 0, !t.isNull) for (var n = yt(t.Resolve(), Ot) || yt(t.container, Ot); n;) {
            this._prevContainers.push(n), n = yt(n.parent, Ot);
          }
          var i = e.Resolve();
          if (null != i) for (var r = yt(i.parent, Ot), a = !0; r && (this._prevContainers.indexOf(r) < 0 || r.countingAtStartOnly);) {
          ...
          switch (h.commandType) {
            ...
            case At.CommandType.PopTunnel:
              var c,
                  ...
                  v,
                  d,
                  p = h.commandType == At.CommandType.PopFunction ? Nt.Function : Nt.Tunnel,
                  y = null;
            ...
            case At.CommandType.ListRandom:
              ...
              if (0 == Y.Count) Q = new Ct();else {
                for (var Z = this.state.storySeed + this.state.previousRandom, tt = new Rt(Z).next(), et = tt % Y.Count, nt = Y.entries(), it = 0; it <= et - 1; it++) {
                  nt.next();
                }
      ...
      value: function value(t, e, n) {
        ...
        if (this.IfAsyncWeCant("call ChoosePathString right now"), null !== this.onChoosePathString && this.onChoosePathString(t, r), i) this.ResetCallstack();else if (this.state.callStack.currentElement.type == Nt.Function) {
          var a = "",
      ...
      value: function value(t, e, n) {
        ...
        for (var o = new St(); this.canContinue;) {
          o.Append(this.Continue());
        }
      ...
      value: function value(t, e) {
        var n;
        if (this.IfAsyncWeCant("remove a variable observer"), null !== this._variableObservers) if (null != e) this._variableObservers.has(e) && (null != t ? null != (n = this._variableObservers.get(e)) && (n.splice(n.indexOf(t), 1), 0 === n.length && this._variableObservers.delete(e)) : this._variableObservers.delete(e));else if (null != t) {
          var i,
              r = pt(this._variableObservers.keys());
      ...
      value: function value() {
        ...
        for (var r = i / n, a = i % n, s = e.path.toString(), o = 0, u = 0, l = s.length; u < l; u++) {
          o += s.charCodeAt(u) || 0;
        }

        for (var h = o + r + this.state.storySeed, c = new Rt(Math.floor(h)), f = [], v = 0; v < n; ++v) {
          f.push(v);
        }
